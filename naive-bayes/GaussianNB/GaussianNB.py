...
def stats(y_train,y_test,y_pred):
	...
	with open("gaussian-naive-bayes-model-stats.txt", "w") as file:
...
if __name__ == '__main__':
	...
	x_train,x_test,y_train,y_test = train_test_split(X.toarray(),y,test_size=0.1)
	...
	for __ in range(10):
		...
		if accuracy > best_accuracy:
			...
			#saving model
			with open("gaussian-naive-bayes-model.pickle", "wb") as file:
				pickle.dump(model, file)'''

	pickle_input = open("gaussian-naive-bayes-model.pickle", "rb")
